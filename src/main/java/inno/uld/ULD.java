...
public class ULD
{
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            ...
            .icon(() -> COPPER_ULD.get().getDefaultInstance())
            .displayItems((parameters, output) -> {
                output.accept(COPPER_ULD.get()); // Add the example item to the tab. For your own tabs, this method is preferred over the event
            }).build());
